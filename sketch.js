var Engine = Matter.Engine,
  ...
  var astronaut,al1,al2,al3,bullet,cloudimg,astro,cloudgroup,ground,alien1,alien2,alien3,b1;
...
function setup (){
 ...
 astro = createSprite(50,height-400,50,50)
...
if(frameCount%100===0){
alien1.x=random(200,width-100)
alien1.y= random(50,25)
}


if(frameCount%100===0){
  alien2.y=random(height-300,height-400)
  alien2.x= random(200,width-100)
  }
